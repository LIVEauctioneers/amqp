[![Build Status](https://api.travis-ci.org/LIVEauctioneers/amqp.svg)](http://travis-ci.org/LIVEauctioneers/amqp) [![GoDoc](https://godoc.org/github.com/LIVEauctioneers/amqp?status.svg)](http://godoc.org/github.com/LIVEauctioneers/amqp)
...
and feature complete, and as of November 2016 has [a team of maintainers](https://github.com/LIVEauctioneers/amqp/issues/215).

Future API changes are unlikely but possible. They will be discussed on [Github
issues](https://github.com/LIVEauctioneers/amqp/issues) along with any bugs or
enhancements.
...
Use [Godoc documentation](http://godoc.org/github.com/LIVEauctioneers/amqp) for
reference and usage.
...
Thanks to the [community of contributors](https://github.com/LIVEauctioneers/amqp/graphs/contributors).
